"""
Version information for ComfyUI Preview Bridge Extended (DazzleNodes).

This file is automatically updated by git pre-commit hooks.
Format: VERSION_BRANCH_BUILD-YYYYMMDD-COMMITHASH

Example: 0.1.0-alpha_main_3-20260107-88bd441
...
__version__ = "0.1.0-alpha_private_7-20260107-abf6648"
